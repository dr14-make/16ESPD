...
@kwdef mutable struct ABSControllerTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :ABSControllerTransient
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = VehicleSystemsComponents.Vehicle.TestABSController(; name=:TestABSController)
end

function DyadInterface.run_analysis(spec::ABSControllerTransientSpec)
...
ABSControllerTransient(;kwargs...) = run_analysis(ABSControllerTransientSpec(;kwargs...))
export ABSControllerTransient, ABSControllerTransientSpec
