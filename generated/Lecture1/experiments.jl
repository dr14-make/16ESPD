...
include("SlipCarPlant_experiment.jl")
include("SlipCruiseIcePatch_experiment.jl")
include("SlipCruiseLoop_experiment.jl")
include("TestClampingPID_experiment.jl")
include("TestHalfSampleDelay_experiment.jl")
include("TestMeasurementNoise_experiment.jl")
include("TestSlipCarPlant_experiment.jl")
include("TestWheeledCarPlant_experiment.jl")
include("WheeledCarPlant_experiment.jl")
include("WheeledCruiseStep_experiment.jl")
