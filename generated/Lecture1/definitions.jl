...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Lecture1", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Lecture1", "definitions.jl"))
end
...
include("ClampingCruiseClimbTransient_definition.jl")
include("ClampingCruiseClimb_definition.jl")
include("ClampingCruiseLoop_definition.jl")
include("ClampingPID_definition.jl")
include("CruiseClimbTransient_definition.jl")
include("CruiseClimb_definition.jl")
include("CruiseLoopStep_definition.jl")
include("CruiseLoopTransient_definition.jl")
include("CruiseLoop_definition.jl")
include("FeedforwardCruiseTransient_definition.jl")
include("FeedforwardCruise_definition.jl")
include("HalfSampleDelay_definition.jl")
include("MeasurementNoise_definition.jl")
include("NoisyCruiseLoop_definition.jl")
include("NoisyCruiseStep_definition.jl")
include("NoisyCruiseTransient_definition.jl")
include("SampledCruiseLoop_definition.jl")
include("SampledCruiseStep_definition.jl")
include("SampledCruiseTransient_definition.jl")
include("SlipCarPlant_definition.jl")
include("SlipCruiseIcePatch_definition.jl")
include("SlipCruiseLoop_definition.jl")
include("SlipCruiseTransient_definition.jl")
include("TestClampingPID_definition.jl")
include("TestHalfSampleDelay_definition.jl")
include("TestMeasurementNoise_definition.jl")
include("TestSlipCarPlant_definition.jl")
include("TestWheeledCarPlant_definition.jl")
include("WheeledCarPlant_definition.jl")
include("WheeledCruiseStep_definition.jl")
include("WheeledCruiseTransient_definition.jl")
