...
include("NoisyCruiseLoop_test.jl")
include("NoisyCruiseStep_test.jl")
include("SampledCruiseLoop_test.jl")
include("SampledCruiseStep_test.jl")
include("SlipCarPlant_test.jl")
include("SlipCruiseIcePatch_test.jl")
include("SlipCruiseLoop_test.jl")
include("TestClampingPID_test.jl")
include("TestHalfSampleDelay_test.jl")
include("TestMeasurementNoise_test.jl")
include("TestSlipCarPlant_test.jl")
include("TestWheeledCarPlant_test.jl")
include("WheeledCarPlant_test.jl")
include("WheeledCruiseStep_test.jl")
