import{b as c,c as k,d as h,e as r,f as p,g as y,h as f,k as $,l as R,n as g,o as b,q as C,r as x,t as z,u as F,v as T}from"./chunk-3N4I7SXW.js";var v="Speaker cues",n,l,s,E,w,o=class extends ${constructor(){super(...arguments);h(this,s);this.deck=null;h(this,n,null);this.report={status:"waiting",index:null,decks:0};h(this,l,null)}connectedCallback(){super.connectedCallback(),p(this,s,E).call(this)}disconnectedCallback(){super.disconnectedCallback(),k(this,n)?.stop(),r(this,n,null)}willUpdate(){this.dataset.deck=this.report.status,document.body.dataset.deck=this.report.status}render(){let{status:e,index:t,decks:d}=this.report,i=this.deck,a=i!==null&&t!==null?i.slides[t]:void 0;if(i!==null&&t!==null&&a===void 0)return f`
        <header>
          <h1>${v}</h1>
