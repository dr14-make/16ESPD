import{a as y,b as f,e as $,f as R,h as g,i as b,k as C,l as x,n as z,q as F,r as T}from"./chunk-G4PRV3WV.js";import{e as c,f as k,g as h,h as r,i as p}from"./chunk-X2XTE53Q.js";var v="Speaker cues",n,l,s,E,w,o=class extends ${constructor(){super(...arguments);h(this,s);this.deck=null;h(this,n,null);this.report={status:"waiting",index:null,decks:0};h(this,l,null)}connectedCallback(){super.connectedCallback(),p(this,s,E).call(this)}disconnectedCallback(){super.disconnectedCallback(),k(this,n)?.stop(),r(this,n,null)}willUpdate(){this.dataset.deck=this.report.status,document.body.dataset.deck=this.report.status}render(){let{status:e,index:t,decks:d}=this.report,i=this.deck,a=i!==null&&t!==null?i.slides[t]:void 0;if(i!==null&&t!==null&&a===void 0)return f`
        <header>
          <h1>${v}</h1>
